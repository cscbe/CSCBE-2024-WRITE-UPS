...
"""
This script requires tesseract to function. In addition, it requires the english language files to be installed.
...
for i in range(len(points)):
    ...
    digit = pytesseract.image_to_string(digit_img, config='--psm 10 --oem 3 -c tessedit_char_whitelist=0123456789').strip()
    digit = int(digit)
